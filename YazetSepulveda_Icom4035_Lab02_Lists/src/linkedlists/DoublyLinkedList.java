...
public class DoublyLinkedList<E> implements List<E> {
	...
	public boolean remove(E obj) {
		...
		if (nextNode != trailer) { // Found it!
			...
			//set the node's (that is after nextNode) previous to curNode
			nextNode.getNext().setPrev(curNode);

			//Removes nextNode from the list
	...
	public boolean remove(int index) {
		...
		//sets the previous of the node that is after rmNode to the node that is before rmNode
		rmNode.getNext().setPrev(rmNode.getPrev());
		//sets the next of the node that is before rmNode to the node that is after rmNode
...
//		if(e.equals(null) || f.equals(null))
//			return counter;

		if(this.isEmpty())
			return counter;

		for(Node curNode = header.getNext(); !curNode.equals(trailer); curNode = curNode.getNext()) {
	...
	public List<E> reverse() {
		...
		for(Node curNode = trailer.getPrev(); !curNode.equals(header); curNode = curNode.getPrev()) {
